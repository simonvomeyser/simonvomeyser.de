        ...
        <div className='mx-auto max-w-screen-lg px-4 '>
          <div className='flex justify-between items-center pt-4 pb-3 sm:py-6'>
            <button className={clsx('w-8 h-8  sm:hidden  transition duration-500',
              {
                'translate-x-20 opacity-0 text-white': isMainNavigationOpen,
              },
            )}
          ...
          <div className='py-4 text-sm  '>
            ...
            <div className='flex flex-col xs:flex-row text-center justify-center sm:justify-end space-y-3 xs:space-y-0 space-x-3'>
